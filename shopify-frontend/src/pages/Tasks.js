...
export default function Tasks() {
  ...
  const formatCompletedTaskRow = (task) => [
    task.name,
    task.description || '-',
    <Badge status="success">
      {task.status}
    </Badge>,
    formatCompletedOn(task),
    renderActions(task),
  ];
          ...
          <Layout.Section>
            <Card sectioned>
              ...
              <DataTable
                ...
                headings={['Name', 'Description', 'Status', 'Completed On', 'Actions']}
